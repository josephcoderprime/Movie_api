...
let allowedOrigins = ['http://localhost:8080', 'https://myflixofficial.netlify.app', 'http://localhost:1234', 'https://myflixofficial.netlify.app', 'http://localhost:4200', 'https://vorl0xvb54.execute-api.eu-central-1.amazonaws.com/dev/api/get-auth-url', 'https://vorl0xvb54.execute-api.eu-central-1.amazonaws.com/dev/api/token'];
